...
public class SeleniumTest {
    ...
    void shouldTestForm() {
        ...
        driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Иван Андросов-Морзе");
    ...
    @Test
    void shouldInvalidFormTelephone() {
    ...
    @Test
    void shouldInvalidFormCheckBox() {
